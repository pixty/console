...
func createPersons(tx common.PartPersister, persons int) []common.Id {
	...
	for ; persons > 0; persons-- {
		p := &common.Person{LastSeenAt: common.CurrentTimestamp()}
...
func findPersons(t *testing.T, tx common.PartPersister, ids []common.Id, expected int) {
